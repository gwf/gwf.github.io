---
title: "GASURF Documentation"
source: html/gasurf.html
---
...
Use a genetic algorithm to find the maximum of a multihumped function. This program serves as an example of how GAs can be used to optimize function which take a multiple floating point arguments. Reproduction of strings entails crossover and mutation with strings being selected based on fitness.
...
GNU ``copyleft'' agreement provided that the author's comments are neither modified nor removed. No warranty is given or implied.
